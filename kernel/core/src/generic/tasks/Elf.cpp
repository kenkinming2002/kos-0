...
namespace core::tasks
{
  ...
  static const Elf32Header* getElf32Header(const char* data, size_t length)
  {
  ...
  static const ELF32ProgramHeader* getElf32ProgramHeaders(const char* data, size_t length, const Elf32Header* header, size_t& count)
  {
